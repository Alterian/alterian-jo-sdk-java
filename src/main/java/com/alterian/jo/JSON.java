...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.AuditLogEntry.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.AuditLogReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.AuditLogReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.CacheDataReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.CacheDataReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.CacheUnusedColumn.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.CacheUnusedColumnsReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.CacheUnusedColumnsReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ClientAccessReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.Cluster.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ClusterDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ClusterResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ClusterResponseAllOfRouteTable.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ClusterSetting.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ClusterStreamData.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ClusterStreamResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ClusterThroughputResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ConsistencyReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ConsistencyReportResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ConversationUsageReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ConversationUsageReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.FieldUsage.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.FieldUsageReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.FieldUsageReportResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.FlowReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.FlowReportResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.GlobalParameterReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.GlobalParameterReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.InternalRuleCallReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.InternalRuleCallReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.Logged404sReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.Opportunitygrid.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.PercentileStatistics.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.Position.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.PriorityWeighting.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.QueueDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.QueueField.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.QueueListing.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.QueueMessage.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.QueueMessageResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.QueuePostMessageResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.QueueResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ROSField.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ResourceExistsReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ResourceExistsReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RouteEntry.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleComplexityReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleComplexityReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleGroup.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleGroupCreation.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleGroupDestinationTarget.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleGroupListing.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleGroupListingResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleGroupParameter.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleGroupParameterDefaultValue.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleGroupParameterDefaultValueOneOf.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleGroupStatistics.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleParamDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.RuleParameter.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ServerSettings.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.ServerSettingsAttribute.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.SnoozeReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.SnoozeReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.StepTypeStatisticsReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.StepTypeStatisticsReportResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.StepTypeUsageReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.StepTypeUsageReportResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.StepUsageReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.StepUsageReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TemplateColumnReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TemplateColumnReportResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TemplateData.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TemplateInputReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TemplateInputReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TemplateUsageReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TemplateUsageReportResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TemplateValidityReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TemplateValidityReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TestDataListing.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TestDataListingResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TestDataResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TokenUseReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.TokenUseReportResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.alterian.jo.model.WorkerThreadUsageReportResponse.CustomTypeAdapterFactory());
