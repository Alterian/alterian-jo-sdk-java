...
public class QueueApi {
     ...
     */
    public QueueResponse queueClientGet(String client, Integer from, Integer to, Boolean includeStatistics) throws ApiException {
        ApiResponse<QueueResponse> localVarResp = queueClientGetWithHttpInfo(client, from, to, includeStatistics);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<QueueResponse> queueClientGetWithHttpInfo(String client, Integer from, Integer to, Boolean includeStatistics) throws ApiException {
     ...
     */
    public okhttp3.Call queueClientGetAsync(String client, Integer from, Integer to, Boolean includeStatistics, final ApiCallback<QueueResponse> _callback) throws ApiException {
     ...
     */
    public QueueResponse queueClientTargetGet(String client, TargetEnum target, Integer from, Integer to, Boolean includeStatistics) throws ApiException {
        ApiResponse<QueueResponse> localVarResp = queueClientTargetGetWithHttpInfo(client, target, from, to, includeStatistics);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<QueueResponse> queueClientTargetGetWithHttpInfo(String client, TargetEnum target, Integer from, Integer to, Boolean includeStatistics) throws ApiException {
     ...
     */
    public okhttp3.Call queueClientTargetGetAsync(String client, TargetEnum target, Integer from, Integer to, Boolean includeStatistics, final ApiCallback<QueueResponse> _callback) throws ApiException {
     ...
     */
    public QueueMessageResponse queueClientTargetQueueNameAckPost(String client, TargetEnum target, String queueName, List<AckMessage> ackMessage) throws ApiException {
        ApiResponse<QueueMessageResponse> localVarResp = queueClientTargetQueueNameAckPostWithHttpInfo(client, target, queueName, ackMessage);
        return localVarResp.getData();
    }
     ...
     * @param queueName The name of queue which contains the message you want to acknowledge (required)
     * @param ackMessage  (optional)
     * @return ApiResponse&lt;QueueMessageResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<QueueMessageResponse> queueClientTargetQueueNameAckPostWithHttpInfo(String client, TargetEnum target, String queueName, List<AckMessage> ackMessage) throws ApiException {
        okhttp3.Call localVarCall = queueClientTargetQueueNameAckPostValidateBeforeCall(client, target, queueName, ackMessage, null);
        Type localVarReturnType = new TypeToken<QueueMessageResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call queueClientTargetQueueNameAckPostAsync(String client, TargetEnum target, String queueName, List<AckMessage> ackMessage, final ApiCallback<QueueMessageResponse> _callback) throws ApiException {
     ...
     */
    public QueueResponse queueClientTargetQueueNameGet(String client, TargetEnum target, String queueName, Boolean includeStatistics) throws ApiException {
        ApiResponse<QueueResponse> localVarResp = queueClientTargetQueueNameGetWithHttpInfo(client, target, queueName, includeStatistics);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<QueueResponse> queueClientTargetQueueNameGetWithHttpInfo(String client, TargetEnum target, String queueName, Boolean includeStatistics) throws ApiException {
     ...
     */
    public okhttp3.Call queueClientTargetQueueNameGetAsync(String client, TargetEnum target, String queueName, Boolean includeStatistics, final ApiCallback<QueueResponse> _callback) throws ApiException {
     ...
     */
    public QueueMessageResponse queueClientTargetQueueNameMessagesGet(String client, TargetEnum target, String queueName, Integer numberOfMessages, Integer maxWaitTimeInSeconds, Boolean deleteAfterRead, String lock) throws ApiException {
        ApiResponse<QueueMessageResponse> localVarResp = queueClientTargetQueueNameMessagesGetWithHttpInfo(client, target, queueName, numberOfMessages, maxWaitTimeInSeconds, deleteAfterRead, lock);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<QueueMessageResponse> queueClientTargetQueueNameMessagesGetWithHttpInfo(String client, TargetEnum target, String queueName, Integer numberOfMessages, Integer maxWaitTimeInSeconds, Boolean deleteAfterRead, String lock) throws ApiException {
     ...
     */
    public okhttp3.Call queueClientTargetQueueNameMessagesGetAsync(String client, TargetEnum target, String queueName, Integer numberOfMessages, Integer maxWaitTimeInSeconds, Boolean deleteAfterRead, String lock, final ApiCallback<QueueMessageResponse> _callback) throws ApiException {
     ...
     * @param queueName The name of the queue that the message will be posted to.. (required)
     * @param body The message that should be posted on to the queue. (required)
     * @return QueuePostMessageResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public QueuePostMessageResponse queueClientTargetQueueNameMessagesPost(String client, TargetEnum target, String queueName, String body) throws ApiException {
        ApiResponse<QueuePostMessageResponse> localVarResp = queueClientTargetQueueNameMessagesPostWithHttpInfo(client, target, queueName, body);
        return localVarResp.getData();
    }
     ...
     * @param queueName The name of the queue that the message will be posted to.. (required)
     * @param body The message that should be posted on to the queue. (required)
     * @return ApiResponse&lt;QueuePostMessageResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<QueuePostMessageResponse> queueClientTargetQueueNameMessagesPostWithHttpInfo(String client, TargetEnum target, String queueName, String body) throws ApiException {
        okhttp3.Call localVarCall = queueClientTargetQueueNameMessagesPostValidateBeforeCall(client, target, queueName, body, null);
        Type localVarReturnType = new TypeToken<QueuePostMessageResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call queueClientTargetQueueNameMessagesPostAsync(String client, TargetEnum target, String queueName, String body, final ApiCallback<QueuePostMessageResponse> _callback) throws ApiException {
     ...
     * @param queueDetails A block of JSON that contains information about the contents of the messages in the queue (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call queueClientTargetQueueNamePostCall(String client, TargetEnum target, String queueName, QueueDetails queueDetails, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = queueDetails;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queueClientTargetQueueNamePostValidateBeforeCall(String client, TargetEnum target, String queueName, QueueDetails queueDetails, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'client' is set
        if (client == null) {
        ...
        if (queueDetails == null) {
            throw new ApiException("Missing the required parameter 'queueDetails' when calling queueClientTargetQueueNamePost(Async)");
        }

        return queueClientTargetQueueNamePostCall(client, target, queueName, queueDetails, _callback);
     ...
     */
    public ResourceAndStatusResponse queueClientTargetQueueNamePost(String client, TargetEnum target, String queueName, QueueDetails queueDetails) throws ApiException {
        ApiResponse<ResourceAndStatusResponse> localVarResp = queueClientTargetQueueNamePostWithHttpInfo(client, target, queueName, queueDetails);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceAndStatusResponse> queueClientTargetQueueNamePostWithHttpInfo(String client, TargetEnum target, String queueName, QueueDetails queueDetails) throws ApiException {
        okhttp3.Call localVarCall = queueClientTargetQueueNamePostValidateBeforeCall(client, target, queueName, queueDetails, null);
     ...
     */
    public okhttp3.Call queueClientTargetQueueNamePostAsync(String client, TargetEnum target, String queueName, QueueDetails queueDetails, final ApiCallback<ResourceAndStatusResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = queueClientTargetQueueNamePostValidateBeforeCall(client, target, queueName, queueDetails, _callback);
        Type localVarReturnType = new TypeToken<ResourceAndStatusResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call queueClientTargetQueueNamePutCall(String client, TargetEnum target, String queueName, QueueDetails queueDetails, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queueClientTargetQueueNamePutValidateBeforeCall(String client, TargetEnum target, String queueName, QueueDetails queueDetails, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'client' is set
        if (client == null) {
        ...
        // verify the required parameter 'queueDetails' is set
        if (queueDetails == null) {
            throw new ApiException("Missing the required parameter 'queueDetails' when calling queueClientTargetQueueNamePut(Async)");
        }

        return queueClientTargetQueueNamePutCall(client, target, queueName, queueDetails, _callback);
     ...
     */
    public ResourceAndStatusResponse queueClientTargetQueueNamePut(String client, TargetEnum target, String queueName, QueueDetails queueDetails) throws ApiException {
        ApiResponse<ResourceAndStatusResponse> localVarResp = queueClientTargetQueueNamePutWithHttpInfo(client, target, queueName, queueDetails);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceAndStatusResponse> queueClientTargetQueueNamePutWithHttpInfo(String client, TargetEnum target, String queueName, QueueDetails queueDetails) throws ApiException {
        okhttp3.Call localVarCall = queueClientTargetQueueNamePutValidateBeforeCall(client, target, queueName, queueDetails, null);
        Type localVarReturnType = new TypeToken<ResourceAndStatusResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call queueClientTargetQueueNamePutAsync(String client, TargetEnum target, String queueName, QueueDetails queueDetails, final ApiCallback<ResourceAndStatusResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = queueClientTargetQueueNamePutValidateBeforeCall(client, target, queueName, queueDetails, _callback);
        Type localVarReturnType = new TypeToken<ResourceAndStatusResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public QueueResponse queueGet(Integer from, Integer to, Boolean includeStatistics) throws ApiException {
        ApiResponse<QueueResponse> localVarResp = queueGetWithHttpInfo(from, to, includeStatistics);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<QueueResponse> queueGetWithHttpInfo(Integer from, Integer to, Boolean includeStatistics) throws ApiException {
     ...
     */
    public okhttp3.Call queueGetAsync(Integer from, Integer to, Boolean includeStatistics, final ApiCallback<QueueResponse> _callback) throws ApiException {
