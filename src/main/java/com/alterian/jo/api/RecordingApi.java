...
public class RecordingApi {
     ...
     * @param target Which target should we filter to? (required)
     * @param name The name of the recording (required)
     * @param since Optional &#39;since&#39; values for paging large data - pass in the value from the last row returned. Use instead of &#39;From&#39; (optional)
     * @param from The zero-based index of the first item to return. (optional)
     * @param to The zero-based index of the last item to return. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call recordingClientTargetNameEventsGetCall(String client, TargetEnum target, String name, String since, Integer from, Integer to, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call recordingClientTargetNameEventsGetValidateBeforeCall(String client, TargetEnum target, String name, String since, Integer from, Integer to, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'client' is set
        if (client == null) {
        ...
        return recordingClientTargetNameEventsGetCall(client, target, name, since, from, to, _callback);
     ...
     */
    public void recordingClientTargetNameEventsGet(String client, TargetEnum target, String name, String since, Integer from, Integer to) throws ApiException {
        recordingClientTargetNameEventsGetWithHttpInfo(client, target, name, since, from, to);
    }
     ...
     */
    public ApiResponse<Void> recordingClientTargetNameEventsGetWithHttpInfo(String client, TargetEnum target, String name, String since, Integer from, Integer to) throws ApiException {
        okhttp3.Call localVarCall = recordingClientTargetNameEventsGetValidateBeforeCall(client, target, name, since, from, to, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call recordingClientTargetNameEventsGetAsync(String client, TargetEnum target, String name, String since, Integer from, Integer to, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = recordingClientTargetNameEventsGetValidateBeforeCall(client, target, name, since, from, to, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
