...
public class TestdataApi {
     ...
     */
    public void downloadTestdataTargetClientRulenameGet(TargetEnum target, String client, String rulename) throws ApiException {
     ...
     */
    public ApiResponse<Void> downloadTestdataTargetClientRulenameGetWithHttpInfo(TargetEnum target, String client, String rulename) throws ApiException {
     ...
     */
    public okhttp3.Call downloadTestdataTargetClientRulenameGetAsync(TargetEnum target, String client, String rulename, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public void testdataGet(Integer from, Integer to) throws ApiException {
     ...
     */
    public ApiResponse<Void> testdataGetWithHttpInfo(Integer from, Integer to) throws ApiException {
     ...
     */
    public okhttp3.Call testdataGetAsync(Integer from, Integer to, final ApiCallback<Void> _callback) throws ApiException {
