...
public class TemplatesApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> A uuencoded octet stream containing the template ktr file </td><td>  -  </td></tr>
     </table>
     */
     ...
     */
    public File downloadTemplateClientTemplatenameGet(String client, String templatename) throws ApiException {
        ApiResponse<File> localVarResp = downloadTemplateClientTemplatenameGetWithHttpInfo(client, templatename);
     ...
     */
    public ApiResponse<File> downloadTemplateClientTemplatenameGetWithHttpInfo(String client, String templatename) throws ApiException {
     ...
     */
    public okhttp3.Call downloadTemplateClientTemplatenameGetAsync(String client, String templatename, final ApiCallback<File> _callback) throws ApiException {
     ...
     * @param client Client name (required)
     * @param templatename The name of the template (required)
     * @param version A uuencoded octet stream containing the template ktr file (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public File downloadTemplateClientTemplatenameVersionGet(String client, String templatename, Integer version) throws ApiException {
        ApiResponse<File> localVarResp = downloadTemplateClientTemplatenameVersionGetWithHttpInfo(client, templatename, version);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<File> downloadTemplateClientTemplatenameVersionGetWithHttpInfo(String client, String templatename, Integer version) throws ApiException {
     ...
     */
    public okhttp3.Call downloadTemplateClientTemplatenameVersionGetAsync(String client, String templatename, Integer version, final ApiCallback<File> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call templateClientTemplatenameVersionPostCall(String client, String templatename, Integer version, String targetClient, Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call templateClientTemplatenameVersionPostValidateBeforeCall(String client, String templatename, Integer version, String targetClient, Object body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'client' is set
        if (client == null) {
        ...
        return templateClientTemplatenameVersionPostCall(client, templatename, version, targetClient, body, _callback);
     ...
     */
    public TemplateUpgradeResponse templateClientTemplatenameVersionPost(String client, String templatename, Integer version, String targetClient, Object body) throws ApiException {
        ApiResponse<TemplateUpgradeResponse> localVarResp = templateClientTemplatenameVersionPostWithHttpInfo(client, templatename, version, targetClient, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TemplateUpgradeResponse> templateClientTemplatenameVersionPostWithHttpInfo(String client, String templatename, Integer version, String targetClient, Object body) throws ApiException {
        okhttp3.Call localVarCall = templateClientTemplatenameVersionPostValidateBeforeCall(client, templatename, version, targetClient, body, null);
     ...
     */
    public okhttp3.Call templateClientTemplatenameVersionPostAsync(String client, String templatename, Integer version, String targetClient, Object body, final ApiCallback<TemplateUpgradeResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = templateClientTemplatenameVersionPostValidateBeforeCall(client, templatename, version, targetClient, body, _callback);
        Type localVarReturnType = new TypeToken<TemplateUpgradeResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
