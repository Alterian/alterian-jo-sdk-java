...
public class DataGridApiResponse {
  ...
  private RuleGroupParameterDefaultValueOneOf data;
  ...
  **/
  ...
  public DataGridApiResponse data(RuleGroupParameterDefaultValueOneOf data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public RuleGroupParameterDefaultValueOneOf getData() {
    return data;
  }

  public void setData(RuleGroupParameterDefaultValueOneOf data) {
    this.data = data;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        RuleGroupParameterDefaultValueOneOf.validateJsonElement(jsonObj.get("data"));
      }
  }
