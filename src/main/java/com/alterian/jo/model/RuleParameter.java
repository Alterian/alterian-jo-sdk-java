...
public class RuleParameter {
  ...
  private Boolean usingGlobal;

  public RuleParameter() {
  }

  public RuleParameter businessGoal(String businessGoal) {
  ...
  **/
  ...
  public RuleParameter client(String client) {
    this.client = client;
    return this;
  }
  ...
  **/
  ...
  public RuleParameter dataType(DataTypeEnum dataType) {
  ...
  **/
  ...
  public RuleParameter description(String description) {
  ...
  **/
  ...
  public RuleParameter globalParam(Boolean globalParam) {
  ...
  **/
  ...
  public RuleParameter isConfidential(Boolean isConfidential) {
  ...
  **/
  ...
  public RuleParameter isEditable(Boolean isEditable) {
  ...
  **/
  ...
  public RuleParameter isForcedValue(Boolean isForcedValue) {
  ...
  **/
  ...
  public RuleParameter isVisible(Boolean isVisible) {
  ...
  **/
  ...
  public RuleParameter name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public RuleParameter picklistItems(List<PickListItem> picklistItems) {
    this.picklistItems = picklistItems;
    return this;
  }

  public RuleParameter addPicklistItemsItem(PickListItem picklistItemsItem) {
  ...
  **/
  ...
  public RuleParameter requiresAdmin(Boolean requiresAdmin) {
  ...
  **/
  ...
  public RuleParameter targets(List<TargetValue> targets) {
    this.targets = targets;
    return this;
  }

  public RuleParameter addTargetsItem(TargetValue targetsItem) {
  ...
  **/
  ...
  public RuleParameter units(String units) {
    this.units = units;
    return this;
  }
  ...
  **/
  ...
  public RuleParameter url(String url) {
    this.url = url;
    return this;
  }
  ...
  **/
  ...
  public RuleParameter defaultValue(String defaultValue) {
  ...
  **/
  ...
  public RuleParameter parameterName(String parameterName) {
  ...
  **/
  ...
  public RuleParameter usingGlobal(Boolean usingGlobal) {
  ...
  **/
  @javax.annotation.Nullable
  public Boolean getUsingGlobal() {
    return usingGlobal;
  }

  public void setUsingGlobal(Boolean usingGlobal) {
    this.usingGlobal = usingGlobal;
  }
  ...
  public boolean equals(Object o) {
    ...
    RuleParameter ruleParameter = (RuleParameter) o;
    return Objects.equals(this.businessGoal, ruleParameter.businessGoal) &&
        Objects.equals(this.client, ruleParameter.client) &&
        Objects.equals(this.dataType, ruleParameter.dataType) &&
        Objects.equals(this.description, ruleParameter.description) &&
        Objects.equals(this.globalParam, ruleParameter.globalParam) &&
        Objects.equals(this.isConfidential, ruleParameter.isConfidential) &&
        Objects.equals(this.isEditable, ruleParameter.isEditable) &&
        Objects.equals(this.isForcedValue, ruleParameter.isForcedValue) &&
        Objects.equals(this.isVisible, ruleParameter.isVisible) &&
        Objects.equals(this.name, ruleParameter.name) &&
        Objects.equals(this.picklistItems, ruleParameter.picklistItems) &&
        Objects.equals(this.requiresAdmin, ruleParameter.requiresAdmin) &&
        Objects.equals(this.targets, ruleParameter.targets) &&
        Objects.equals(this.units, ruleParameter.units) &&
        Objects.equals(this.url, ruleParameter.url) &&
        Objects.equals(this.defaultValue, ruleParameter.defaultValue) &&
        Objects.equals(this.parameterName, ruleParameter.parameterName) &&
        Objects.equals(this.usingGlobal, ruleParameter.usingGlobal);
  }

  @Override
  public int hashCode() {
    return Objects.hash(businessGoal, client, dataType, description, globalParam, isConfidential, isEditable, isForcedValue, isVisible, name, picklistItems, requiresAdmin, targets, units, url, defaultValue, parameterName, usingGlobal);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to RuleParameter
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleParameter is not found in the empty JSON string", RuleParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleParameter>() {
           @Override
           public void write(JsonWriter out, RuleParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleParameter read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RuleParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RuleParameter
  * @throws IOException if the JSON string is invalid with respect to RuleParameter
  */
  public static RuleParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleParameter.class);
  }

 /**
  * Convert an instance of RuleParameter to an JSON string
  *
  * @return JSON string
  */
