...
public class ROSCounts {
  ...
  **/
  ...
  public ROSCounts fields(List<ROSField> fields) {
    this.fields = fields;
    return this;
  }

  public ROSCounts addFieldsItem(ROSField fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  ...
  public void setFields(List<ROSField> fields) {
    this.fields = fields;
  }
      ...
      if (jsonObj.get("fields") != null && !jsonObj.get("fields").isJsonNull()) {
        ...
        if (jsonArrayfields != null) {
          ...
          for (int i = 0; i < jsonArrayfields.size(); i++) {
            ROSField.validateJsonElement(jsonArrayfields.get(i));
          };
        }
      }
