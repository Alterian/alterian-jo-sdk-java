...
public class LogsData {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.agent, logsData.agent) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agent, client, ecs, event, fields, host, info, input, level, log, logType, loglevel, msg, node, nodeName, nodeDesc, restartSequence, rule, ruleLogEntry, seq, step, tags, target, templateUrl, tileId, tileName, timestamp, version, additionalProperties);
  }
